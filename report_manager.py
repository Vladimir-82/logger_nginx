...
class NginxReportManager:
    ...
    def get_parsed_lines(self, opener: partial, full_path: str) -> tuple[UrlsData, float]:
        """Получение распарсенного массива данных и отношения числа строк в массиве данных к числу строк в файле.

        Отношение числа строк в массиве данных к числу строк в файле нужно для отображение прогресса.
        """
